...
module Tut7_3_M1 where  -- $$$ Exercise 7.3
  ...
  case ir_op of
    ...
    15 -> -- expand to RX format
      ...
      case ir_sb of
        ...
        7 ->            -- $$$ Exercise 7.2
          state_newRX7:    -- $$$ Exercise 7.2
            assert [ctl_new_signal]   -- $$$ Exercise 7.3
...
control reset ir cond = (state,start,ctl_signals)
  where
      ...
      state_newRX7 = dff (pRX!!7)  -- $$$ Exercise 7.2
      ...
      ctl_new_signal = orw [state_newRX7] -- $$$ Exercise 7.3
