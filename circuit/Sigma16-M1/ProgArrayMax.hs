...
To run the simulation using ghci, enter
  ghci
  :load ProgArrayMax
  main

To run the simulation with compiled code, enter
  ghc --make ProgArrayMax
  ./ArrayMax
-}
...
-- ~~~~~~~~~~~~~~~~  ~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 [
  ...
  "f004", "0008", -- 0012        jumpf R0,loop[R0]     ; go to top of loop
                  -- 0014             
                  -- 0014 ; Exit from loop
                  -- 0014
