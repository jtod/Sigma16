...
# Foundation.  Sigma16 is distributed in the hope that it will be
...
# 2024-08-01 moved makefile from Sigma16 to Sigma16/src.  This
# requires changes to paths but simplifies the top directory.
