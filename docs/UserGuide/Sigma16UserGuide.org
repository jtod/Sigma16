...
# Build Sigma16 User Guide: C-c C-e P p --- Build document project
# containing current file.  Configuration in ~/.emacs.d/init.el
...
#+BEGIN_majornote
This version of Sigma16 runs in Chrome, Edge, and Opera (the browsers
