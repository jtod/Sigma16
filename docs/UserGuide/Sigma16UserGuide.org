...
|                    |      |      | M[Rf+gh+e-d] := Re          |
|--------------------+------+------+-----------------------------|
| rst Rd,Re,gh[Rf]   | e,0b |      | Rd := M[Rf+gh]              |
|                    |      |      | Rd+1 := M[Rf+gh+1]          |
|                    |      |      | ...                         |
|                    |      |      | Re := M[Rf+gh+e-d]          |
|--------------------+------+------+-----------------------------|
...
+----------------------+------+------+-----------------------------+
| ljumpz Rd,disp[Ra]   | e,00 | Ed00 | Rd.f:g := h#(Rd.f:g,Re.f:g) |
+----------------------+------+------+-----------------------------+
| ljumpnz Rd,disp[Ra]  | e,00 | Ed00 | Rd.f:g := h#(Rd.f:g,Re.f:g) |
+----------------------+------+------+-----------------------------+
...
+----------------------+------+------+-----------------------------+
| lextract Rd,Re,f,g,h | e,05 |      | Rd.f~g :=                   |
+----------------------+------+------+-----------------------------+
