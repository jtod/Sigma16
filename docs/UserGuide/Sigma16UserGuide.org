...
| div d,a,b    |  3 | 3dab | R[d] := R[a]/R[b], R[15] := R[a]%R[b] |
...
|                      |      |           | M[Rf+gh+e-d] := Re                       |
+----------------------+------+-----------+------------------------------------------+
| restore Rd,Re,gh[Rf] | e,0b |           | Rd := M[Rf+gh], ..., Re := M[Rf+gh+e-d]  |
+----------------------+------+-----------+------------------------------------------+
| brc0 Rd,e,fgh        | e,0c | Ed0C,efgh | if R[d].e=0 then pc:=pc+fgh              |
+----------------------+------+-----------+------------------------------------------+
| brc1 Rd,e,fgh        | e,0d | Ed0D,efgh | if R[d].e=1, then pc:=pc+fgh             |
+----------------------+------+-----------+------------------------------------------+
...
+----------------------+------+-----------+------------------------------------------+
| resume               | e,13 |           | pc := ipc, status := istatus, Privileged |
+----------------------+------+-----------+------------------------------------------+
...
| Assembly            | Op   | Code      | Effect          |
|---------------------+------+-----------+-----------------|
| ladd Rd,Re,Rf       | e,16 | Ed16,ef00 | Rd := Re+rf     |
| lsub Rd,Re,Rf       | e,17 | Ed17,ef00 | Rd := Re+rf     |
...
| Assembly             | Op   | Code     | Effect                     |
|----------------------+------+----------+----------------------------|
| llogicf Rd,Rb,p,q,h  | e,00 | FdbD,mnh | Rd.m:n := h(Rd.m:n,Rb.m:n) |
| llogicb Rd,Re,p,q,h  | e,01 | FdeE,mnh | Rd.f := h(Rd.f,Re.g)       |
| lextract Rd,Re,p,q,h | e,05 | FdeF,mnh | Rd.f~g :=                  |
