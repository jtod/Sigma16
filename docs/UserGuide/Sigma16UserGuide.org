...
| Assembly            | Op   | Code | Effect          |
+---------------------+------+------+-----------------+
| xadd Rd,Re,Rf       | e,16 | Ed16 | Rd := Re+rf     |
|                     |      | ef00 | Rd := Re+rf     |
+---------------------+------+------+-----------------+
| xsub Rd,Re,Rf       | e,17 | Ed17 | Rd := Re+rf     |
|                     |      | ef00 | Rd := Re+rf     |
+---------------------+------+------+-----------------+
| xmul Rd,Ra,Rb       | e,18 | Ed18 | Rd := Re+rf     |
|                     |      | ef00 | Rd := Re+rf     |
+---------------------+------+------+-----------------+
| xdiv Rd,Ra,Rb       | e,19 | Ed19 | Rd := Re+rf     |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xcmp Rd,Ra,Rb       | e,1a | Ed1A | Rd := Re+rf     |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xlea Rd,fgh[Re]     | e,1b | Ed1B | Rd := fgh+Re    |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xload Rd,fgh[Re]    | e,1c | Ed1C | Rd := M[fgh+Re] |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xstore Rd,fgh[Ra]   | e,1d | Ed1D | M[fgh+Re] := Rd |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xjumpz Rd,disp[Ra]  | e,00 | Ed00 |                 |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xjumpnz Rd,disp[Ra] | e,00 | Ed00 |                 |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xshiftl Rd,Re,h     | e,03 |      | Rd := Re shl h  |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xshiftr Rd,Re,h     | e,04 |      | Rd := Re shr h  |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xpush Rd,Re,Rf      | e,05 |      | Rd.f~g :=       |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xpop Rd,Re,Rf       | e,05 |      | Rd.f~g :=       |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xtop Rd,Re,Rf       | e,05 |      | Rd.f~g :=       |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xsave Rd,Re,gh[Rf]  | e,05 |      | Rd.f~g :=       |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
| xrest Rd,Re,gh[Rf]  | e,05 |      | Rd.f~g :=       |
|                     |      |      |                 |
+---------------------+------+------+-----------------+
#+BEGIN_EXPORT html
</div>
