...
# ----------------------------------------------------------------
# Initialising (essential because el file is required):
#   load Sigma16.el and visit directory:  M-x Sigma16
# Building:
#   update dynamic blocks, including BUILD_ID:  C-u C-c C-x C-u
#   save file:  C-x s  (y)
#   export html:  C-c C-e h h
#   export pdf via latex:  C-c C-e l p
#   export tex:  C-c C-e l l
# ----------------------------------------------------------------
...
# A code listing won't be indented properly if the first character
# is a space, which is usually the case.  To get proper
# indentation, begin each code fragment with a non-space
# character, which could be a letter (e.g. from a label) or a
# nonbreakable space.  To insert nonbreakable space (Unicode hard
# space), enter: C-x 8 space M-x.  Alternatively, insert-character
# 21D2
...
# Update dynamic blocks: C-u C-c C-x C-u
# This will automatically put build timestamp at end
#+BEGIN_BUILD_ID
#+BEGIN: update-build-id :format "%Y-%m-%d at %H:%M"
Build: 2025-11-28 at 12:26
#+END
#+END_BUILD_ID
...
# #+HTML_PREAMBLE: "<h1 class=\"title\">%t</h1> <p class=\"author\">%a</p> <p class=\"date\">%d</p>"

# #+OPTIONS: HTML_PREAMBLE: "This is my super preamble"
#  #+HTML_PREAMBLE: <div class="preamble">Welcome to my custom
# preamble!</div>
