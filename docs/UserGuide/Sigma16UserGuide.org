...
2. Indication if the instruction is Core or S32, followed by the
   [[expanding-opcode][full expanded operation code]] and the
...
|------------------------------------------------------------+-----------+-------------------------------|
| *S32* <<xcmp-t>> [[xcmp-d][xcmp]] Rd,Ra,Rb                 |           |                               |
| [e,24] iEXP/aRR                                            |           |                               |
| xcmp R12,R5                                                | e900 37f2 |                               |
|------------------------------------------------------------+-----------+-------------------------------|
...
- These may involve using the existing sofware, modifying the
  existing software, or writing new software from scratch
- It's important to cite Sigma16 properly, and to adhere to the
  sofware license
- Documentation
