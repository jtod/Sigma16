...
| Assembly             | Op   | Code | Effect                      |
+----------------------+------+------+-----------------------------+
| logicf Rd,Re,f,g,h   | e,00 | Ed00 | Rd.f:g := h#(Rd.f:g,Re.f:g) |
+----------------------+------+------+-----------------------------+
|                      |      | efgh |                             |
+----------------------+------+------+-----------------------------+
...
|                      |      |      |                             |
+----------------------+------+------+-----------------------------+
| save Rd,Re,gh[Rf]    | e,0a |      | M[Rf+gh] := Rd              |
+----------------------+------+------+-----------------------------+
|                      |      |      | M[Rf+gh+1] := Rd+1          |
+----------------------+------+------+-----------------------------+
|                      |      |      | ...                         |
...
|                      |      |      | M[Rf+gh+e-d] := Re          |
+----------------------+------+------+-----------------------------+
| restore Rd,Re,gh[Rf] | e,0b |      | Rd := M[Rf+gh]              |
+----------------------+------+------+-----------------------------+
|                      |      |      | Rd+1 := M[Rf+gh+1]          |
+----------------------+------+------+-----------------------------+
|                      |      |      | ...                         |
...
|                      |      |      | Re := M[Rf+gh+e-d]          |
+----------------------+------+------+-----------------------------+
| brc0 Rd,e,fgh        | e,0c | Ed0C | if R[d].e=0                 |
+----------------------+------+------+-----------------------------+
|                      |      | efgh | then pc:=pc+fgh             |
+----------------------+------+------+-----------------------------+
| brc1 Rd,e,fgh        | e,0d | Ed0D | if R[d].e=1                 |
+----------------------+------+------+-----------------------------+
|                      | e,0d | efgh | then pc:=pc+fgh             |
+----------------------+------+------+-----------------------------+
| brz Rd,efgh          | e,0e | Ed0E | if R[d]=0000                |
+----------------------+------+------+-----------------------------+
|                      |      | efgh | then pc:=pc+efgh            |
+----------------------+------+------+-----------------------------+
| brnz Rd,efgh         | e,0f | Ed0F | if R[d]!=0000               |
+----------------------+------+------+-----------------------------+
|                      |      | efgh | then pc:=pc+efgh            |
+----------------------+------+------+-----------------------------+
| dispatch Rd,efgh     | e,10 | Ed10 | pc := M[pc+min(Rd,efgh)]]   |
+----------------------+------+------+-----------------------------+
|                      |      | efgh |                             |
+----------------------+------+------+-----------------------------+
...
+----------------------+------+--------+------------+-----------------------------+
| addl Rd,Re,Rf        | e,16 | EXP    | Ed16; ef00 | Rd := Re+rf                 |
+----------------------+------+--------+------------+-----------------------------+
| subl Rd,Re,Rf        | e,17 | EXP    | Ed17; ef00 | Rd := Re+rf                 |
+----------------------+------+--------+------------+-----------------------------+
| mull Rd,Ra,Rb        | e,16 | EXP    | Ed16       | Rd := Re+rf                 |
+----------------------+------+--------+------------+-----------------------------+
| divl Rd,Ra,Rb        | e,16 | EXP    | Ed16       | Rd := Re+rf                 |
+----------------------+------+--------+------------+-----------------------------+
| cmpl Rd,Ra,Rb        | e,16 | EXP    | Ed16       | Rd := Re+rf                 |
+----------------------+------+--------+------------+-----------------------------+
| leal Rd,disp[Ra]     | f,0  |        | $f d a $0  | R[d] := disp+R[a]           |
+----------------------+------+--------+------------+-----------------------------+
| loadl Rd,disp[Ra]    | f,1  |        | $f d a $1  | R[d] := M[disp+R[a]]        |
+----------------------+------+--------+------------+-----------------------------+
| storel Rd,disp[Ra]   | f,2  |        | $f d a $2  | M[disp+R[a]] := R[d]        |
+----------------------+------+--------+------------+-----------------------------+
| logicfl Rd,Re,f,g,h  | e,00 | EXP    | Ed00       | Rd.f:g := h#(Rd.f:g,Re.f:g) |
+----------------------+------+--------+------------+-----------------------------+
| logicbl Rd,Re,f,g,h  | e,01 | EXP    | Ed01       | Rd.f := h(Rd.f,Re.g)        |
+----------------------+------+--------+------------+-----------------------------+
| shiftll Rd,Re,h      | e,03 | EXP    |            | Rd := Re shl h              |
+----------------------+------+--------+------------+-----------------------------+
| shiftrl Rd,Re,h      | e,04 | EXP    |            | Rd := Re shr h              |
+----------------------+------+--------+------------+-----------------------------+
| extractl Rd,Re,f,g,h | e,05 | EXP    |            | Rd.f~g :=                   |
+----------------------+------+--------+------------+-----------------------------+
