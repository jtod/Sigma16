# Usage: pdflatex --shell-escape Sigma16UserGuide
...
#+MACRO: FIGURES ./figures/


        
# Provide appropriate code for svg figure depending on export backend
# See org-export-global-macros defined in ox.el and changed in init.el
